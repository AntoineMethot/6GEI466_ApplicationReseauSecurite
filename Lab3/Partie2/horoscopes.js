// horoscopes.js
module.exports = {
  Aries: { image: "ARIES.png", text: `De nouvelles idées émergent et ta motivation est en hausse. C’est un bon moment pour prendre des initiatives, proposer quelque chose ou te démarquer. Assure-toi simplement de bien communiquer pour éviter les malentendus.
...
Fonce, mais avec intention. Choisis tes combats et fais confiance à ton instinct… tout en gardant un œil sur les détails.` },
  ...
  Taurus: { image: "TAURUS.png", text: `Tu es en phase de stabilisation et de consolidation. C’est un moment propice à l’organisation, à la planification et à la mise en œuvre de projets. Sois patient et méthodique.
...
Sois patient et méthodique. La stabilité est ton allié.` },
  ...
  Gemini: { image: "GEMINI.png", text: `Tu es en phase de changement et d’adaptation. C’est un moment propice à l’apprentissage, à la communication et à l’échange d’idées. Sois ouvert à de nouvelles perspectives et n’hésite pas à explorer des solutions créatives.
...
Sois curieux et ouvert. L’apprentissage et l’échange sont tes alliés.` },
  ...
  Cancer: { image: "CANCER.png", text: `Tu es en phase de réflexion et d’introspection. C’est un moment propice à la planification, à la prise de recul et à l’analyse des situations. Sois attentif à tes émotions et n’hésite pas à demander de l’aide si nécessaire.
...
Sois attentif à tes émotions. La réflexion et l’introspection sont tes alliées.` },
  ...
  Leo: { image: "LEO.png", text: `Tu es en phase de confiance en toi et d’expression. C’est un moment propice à prendre des initiatives, à te démarquer et à faire valoir tes compétences. Sois ouvert à l’attention que tu reçois, mais reste humble.
...
Sois confiant et authentique. Ton énergie positive peut inspirer les autres.` },
  ...
  Virgo: { image: "VIRGO.png", text: `Tu es en phase de perfectionnement et d’organisation. C’est un moment propice à l’analyse, à la planification et à l’optimisation des processus. Sois attentif aux détails et n’hésite pas à améliorer tes méthodes.
...
Sois attentif aux détails. La perfection et l’organisation sont tes alliés.` },
  ...
  Libra: { image: "LIBRA.png", text: `Tu es en phase d’équilibre et de diplomatie. C’est un moment propice à la collaboration, à l’harmonie et à la prise de décision. Sois ouvert aux différents points de vue et n’hésite pas à chercher un terrain d’entente.
...
Sois diplomate et ouvert. L’équilibre et l’harmonie sont tes alliés.` },
  ...
  Scorpio: { image: "SCORPIO.png", text: `Tu es en phase de transformation et de profondeur. C’est un moment propice à l’analyse, à la recherche et à la prise de décisions importantes. Sois attentif à tes instincts et n’hésite pas à creuser les sujets en profondeur.
...
Sois attentif à tes instincts. La profondeur et la transformation sont tes alliées.` },
  ...
  Sagittarius: { image: "SAGITTARIUS.png", text: `Tu es en phase d’expansion et d’aventure. C’est un moment propice à l’exploration, à l’apprentissage et à la prise de risques calculés. Sois ouvert aux nouvelles opportunités et n’hésite pas à sortir de ta zone de confort.
...
Sois aventureux et curieux. L’expansion et l’apprentissage sont tes alliés.` },
  ...
  Capricorn: { image: "CAPRICORN.png", text: `Tu es en phase de discipline et de responsabilité. C’est un moment propice à la planification, à la mise en œuvre de projets et à la prise de décisions importantes. Sois attentif à tes objectifs et n’hésite pas à travailler dur pour les atteindre.
...
Sois discipliné et responsable. La persévérance est ta meilleure alliée.` },
  ...
  Aquarius: { image: "AQUARIUS.png", text: `Tu es en phase d’innovation et de créativité. C’est un moment propice à l’exploration de nouvelles idées, à la collaboration et à la prise de risques calculés. Sois ouvert aux nouvelles perspectives et n’hésite pas à sortir des sentiers battus.
...
Sois innovant et créatif. L’originalité et la collaboration sont tes alliées.` },
  ...
  Pisces: { image: "PISCES.png", text: `Tu es en phase d’intuition et de sensibilité. C’est un moment propice à la réflexion, à la créativité et à l’écoute de tes instincts. Sois attentif à tes émotions et n’hésite pas à exprimer tes idées de manière artistique ou originale.
